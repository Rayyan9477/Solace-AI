...
class Telemetry:
    ...
    def __new__(cls, config: TelemetryConfig | None = None) -> "Telemetry":
...
def get_telemetry(config: TelemetryConfig | None = None) -> Telemetry:
...
SafetyServiceTelemetry = Telemetry
